...
/**
 *@brief Shuffles a vector of strings
 *
 *Private helper method meant to shuffle the cities in Middle Earth
 *
 */
...
/**
 *@brief Constructor for creating a Middle Earth object
 *Will initialize the cities vector with all the cities inside all_city_names, then will 
 *remove elements from the vector until the vector size is equal to num_cities. Then, will
 *place each city randomly inside a map. Finally, will compute distances and place inside distance array.
 *@param xsize- the number of rows of the distance array
 *@param ysize - the number of cols of the distance array
 *@param num_cities - the number of cities in Middle Earth
 *@param seed - the seed used to generate the random distances
...
/**
 *@brief Prints out the city name and its x and y position for every city inside cities
 *@author Aaron Bloomfield
 *Iterates through the cities vector, and grabs the x and y position from the xpos and ypos maps
 *
 */
...
/**
 *@brief Prints out the table of the distances
 *Will first print out the city names
 *Then, will print out the name of the first city, it's x position and y position
 *and the respective distances to each other city
 *
 * @author Aaron Bloomfield
 */
...
/**
 *@brief Returns the distance given two cities
 *@pre The distances between each city is computed i.e. The constructor was called
 *@author - Aaron Bloomfield
 */
...
/**
 *@brief Will get a vector of the cities to travel to to reach a certain travel distance
 *If the length is greater than the number of cities, will return a warning and end the function
 *Will initialize the vector to return with all the cities, shuffle them, and remove cities until the vector size
 *is eqivalent to the length
 *@param length of the trip
 *@return Vecor of strings representing each city to travel to
 */
